...
function ProjectCard({ project, span, onOpenProject }) {
  ...
  return (
    ...
    >
      {/* Thumbnail — pakai screenshot asli jika ada, fallback ke gradient + ikon */}
      <div
      ...
      <div className="flex flex-col flex-1 p-4 min-w-0">
        ...
        {/* Action buttons — selalu terlihat, tanpa perlu hover */}
          ...
          <div className="flex items-center gap-2 mt-4 pt-3 border-t border-white/10">
            {project.liveUrl && (
              <a
                ...
                className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-white text-slate-900 text-[11px] font-semibold hover:scale-105 active:scale-95 transition-all"
              >
            ...
            {project.githubUrl && (
              <a
                ...
                rel="noopener noreferrer"
                onClick={(e) => e.stopPropagation()}
                className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg glass-button text-[11px] font-semibold text-white/85"
              >
